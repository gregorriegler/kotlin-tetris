...
class `A Tetris` {
    ...
    inner class `with a single column should` {
        private var tetris = Tetris(Frame(1, 3), listOf(Structure.create1by1()))
    ...
    inner class `with two columns should` {
        private var tetris = Tetris(Frame(2, 3), listOf(Structure.create1by1()))
    ...
    inner class `with three columns should` {
        private var tetris = Tetris(Frame(3, 3), listOf(Structure.create1by1()))
