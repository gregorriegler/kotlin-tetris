...
class `A Field` {
    ...
    @Test
    fun `can create bomb`() {
        val bomb = Field.bomb(Position(0, 3))
    ...
    @Test
    fun erases() {
        assertThat(Field.filled(Position(0, 0)).erase()).isEqualTo(Field.empty(Position(0, 0)))
        assertThat(Field.empty(Position(0, 0)).erase()).isEqualTo(Field.empty(Position(0, 0)))
    }

    @Test
    fun compares() {
        assertThat(Field.filled(Position(0, 0)).compareTo(Field.filled(Position(0, 0)))).isEqualTo(0)
        assertThat(Field.filled(Position(1, 0)).compareTo(Field.filled(Position(0, 0)))).isGreaterThan(0)
        assertThat(Field.filled(Position(0, 1)).compareTo(Field.filled(Position(0, 0)))).isGreaterThan(0)
        assertThat(Field.filled(Position(0, 0)).compareTo(Field.filled(Position(1, 0)))).isLessThan(0)
        assertThat(Field.filled(Position(0, 0)).compareTo(Field.filled(Position(0, 1)))).isLessThan(0)
    }
}